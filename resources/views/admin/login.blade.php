...
<form class="form-horizontal" action="{{url('logindo')}}" method='post' role="form" enctype="multipart/form-data">
   ...
   <div class="input-content">
     ...
     <p class="p user_icon">
       <input type="text" placeholder="账号" autocomplete="off" name="admin_name" class="login_txtbx">
     </p> 
     <p class="p pwd_icon">
       <input type="password" placeholder="密码" autocomplete="off" name='admin_pwd' class="login_txtbx">
     </p>       
    
     <input name="rember" type="checkbox" />
              <span><font color=silver>七天免登录</font></span>

    <div class="signup">
      <input style="background-color:silver ; " name="" type="submit" value="安全登录" class="btn"/>
